...
import com.onfis.announcement.dto.AnnouncementUpdateRequestDTO;
...
public class AnnouncementController {
    ...
    public ResponseEntity<Page<AnnouncementDTO>> getDepartment(
        ...
        return ResponseEntity
                .ok(announcementService.getCurrentUserDepartmentAnnouncements(token, companyId, userId, pageable));
    }
  ...
  public ResponseEntity<AttachmentResponseDTO> getAttachmentById(@PathVariable("id") UUID id) {
    ...
    public ResponseEntity<AnnouncementCommentResponseDTO> addComment(
        ...
        AnnouncementCommentResponseDTO newComment = announcementService.addComment(token, companyId, announcementId,
                userId, request);
    ...
    public ResponseEntity<AnnouncementDTO> updateAnnouncement(
        ...
        log.info("📥 Nhận yêu cầu cập nhật bài đăng {} từ User: {}", announcementId, userId);
        AnnouncementDTO updated = announcementService.updateAnnouncement(token, companyId, userId, announcementId,
                request);
    ...
    public ResponseEntity<Void> deleteAnnouncement(
        ...
        log.info("📥 Nhận yêu cầu xóa bài đăng {} từ User: {}", announcementId, userId);
        announcementService.deleteAnnouncement(token, companyId, userId, announcementId);
    ...
    public ResponseEntity<Void> deleteAttachment(
        ...
        announcementService.deleteAttachment(token, companyId, attachmentId, userId);
        return ResponseEntity.noContent().build();
    }
}